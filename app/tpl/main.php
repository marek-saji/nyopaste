...
<div id="top">
    ...
    <header id="head">
        <h1>
            <?= $t->l2c('<span class="kern_n">n</span><span class="kern_ny y">y</span><span class="kern_yo">o</span><span class="kern_op">p</span><span class="kern_pa">a</span><span class="kern_as">s</span><span class="kern_st">t</span><span class="kern_te">e</span>', '', '', array(), array('class'=>'nyopaste')); ?>
        </h1>

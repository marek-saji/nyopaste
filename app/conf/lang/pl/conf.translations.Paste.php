...
$conf['translations']['Paste'] = array(
    ...
    'List of tags that will be helpful in searching this paste. You can also use them to group pastes at <a href="%s">your profile page</a>.'
        => 'Lista etykiet, które pozwolą na łatwiejsze wyszukanie wpisu. Możesz ich również użyć do grupowania wpisów na <a href="%s">swoim profilu</a>.'
    'List of tags that will be helpful in searching this paste. After you <a href="%s">sign in</a>, you will be able to use them to group pastes at your profile page.'
        => 'Lista etykiet, które pozwolą na łatwiejsze wyszukanie wpisu. Kiedy się <a href="%s">zalogujesz</a> będziesz mógł ich również użyć do grupowania wpisów na swoim profilu.'
